    ...
    <main className={`min-h-screen flex flex-col lg:flex-row ${current.bg} ${current.text}`}>
      <div className="w-full lg:w-[45%] p-6 md:p-12 lg:p-20 flex flex-col justify-center">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter mb-4 uppercase">
            Create Account
          </h1>
      ...
      <div className="hidden lg:flex flex-1 relative bg-[#05070a] border-l border-white/5 p-20 flex-col justify-center items-center text-center overflow-hidden">
        <motion.div
          animate={{
            background: [
              ...
              'radial-gradient(circle at 60% 40%, rgba(37, 99, 235, 0.15) 0%, transparent 70%)',
            ],
          }}
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-xl text-white/50 mb-16 leading-relaxed">
            Create your account today and unlock access to our premium fleet. Your next adventure
            starts here.
          </p>
          ...
          <div className="grid grid-cols-2 gap-6 text-left">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="p-6 rounded-3xl bg-white/5 border border-white/5 backdrop-blur-3xl"
              >
