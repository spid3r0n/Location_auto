...
const marqueeCars = [
  "Ferrari Roma", "Lamborghini Huracan", "Bentley Continental GT", 
  "Aston Martin Vantage", "Rolls Royce Ghost", "McLaren 720S"
];
    ...
    <div className={`min-h-screen transition-colors duration-1000 ${current.bg} ${current.text} overflow-hidden font-sans relative`}>
      ...
      <section className="relative min-h-screen grid grid-cols-12 pt-20">
        ...
        <div className="col-span-12 lg:col-span-7 flex flex-col justify-center px-8 md:px-20 relative z-10">
          ...
          >
            <Link to="/register" className={`px-12 py-6 rounded-full font-black uppercase text-[10px] tracking-[0.2em] transition-all hover:scale-105 ${current.glow} ${current.btn}`}>
              Start Engine
            </Link>
        ...
        {/* Bottom Decorative Marquee - Image Driven */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-10">
            <div className="max-w-xl">
              ...
              <p className={`${current.subtext} text-xl leading-relaxed`}>Découvrez notre flotte exclusive, où chaque véhicule est une invitation à l'exceptionnel. Des performances brutes au luxe absolu.</p>
            </div>
            <Link to="/fleet" className="px-10 py-5 rounded-full border border-current/20 font-bold text-xs uppercase tracking-widest group hover:bg-current hover:text-black transition-all">
              View All Fleet 
      ...
      <section className="py-40 px-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <Link to="/login" className={`inline-block px-20 py-7 text-white font-black uppercase text-xs tracking-[0.3em] rounded-full ${current.glow} hover:scale-110 transition-all ${theme === 'cyber' ? 'bg-fuchsia-600' : 'bg-blue-600'}`}>
